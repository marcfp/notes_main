...
class MainForm(QtGui.QWidget):
    def __init__(self):
        ...
        self.db.setDatabaseName("kodekraft")
        self.db.setUserName("marc")
        self.db.setPassword("datsxkul")
        ok = self.db.open()    
        if not ok:
        ...
        label_fn = QtGui.QLabel('Primer Cognom:')
        label_ln = QtGui.QLabel('Segon Cognom:')
        ...
        self.model.setHeaderData(1, QtCore.Qt.Horizontal, self.tr("Primer Cognom"))
        self.model.setHeaderData(2, QtCore.Qt.Horizontal, self.tr("Segon Cognom"))
